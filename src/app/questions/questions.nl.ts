...
export const questionsNl: Question[] = [
  {
    ...
    summary: 'Bedankt! Aarzel niet om over dit voorstel te spreken met vrienden, collega’s, buren, familie. Share, like en retweet onze filmpjes en berichten op sociale media. Op deze website vind je ook de mogelijkheid om tweets en mails te adresseren aan politici naar keuze. Als je gelooft ons op andere manieren te kunnen ondersteunen, stuur dan een mailtje naar info@thecitizensparliament.be.',
    answer: '',
    ...
    summary: 'Klopt. Na lang onderhandelen leverde België net op de valreep haar <a target="_blank" href="https://www.nationaalenergieklimaatplan.be/nl/wat-is-het-nekp#het-definitief-plan">Nationaal Energie- en Klimaatplan</a> in bij de Europese Commissie. Dit is de bundeling van de afzonderlijke plannen van de drie gewesten. Samen wordt gemikt op een reductie van de CO2 uitstoot van 35% t.o.v. 1990. Nu, nog geen twee jaar het indienen van dat plan, heeft Europa de lat echter heel wat hoger gelegd: op 55%. Het laaghangend fruit is al geplukt. En op twee jaar tijd zijn de perspectieven niet verbeterd, integendeel. Onze nieuwe regering belooft vast te houden aan de kernuitstap, hetgeen gecompenseerd wordt met vijf splinternieuwe gascentrales die <a target="_blank" href="https://www.energyville.be/nieuws-events/energyville-lanceert-aanvullende-systeemscenarios-voor-elektriciteitsvoorziening">25 Megaton extra CO2 uitstoten</a>. Het zal dus een moeilijke puzzel worden, waar de regering harde keuzes zal moeten maken. Liever met burgers mee aan tafel… Ten slotte behandelt dit plan enkel energie en CO2-uitstoot, terwijl het andere ecologische domeinen negeert: biodiversiteitsverlies, verontreiniging,...',
    answer: '',
