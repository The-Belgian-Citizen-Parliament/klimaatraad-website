...
export const questionsNl: Question[] = [
  {
    ...
    summary: 'In Frankrijk kostte een gelijkaardig initiatief, de <a target="_blank" href="https://www.conventioncitoyennepourleclimat.fr/budget/">Convention Citoyenne pour le Climat</a>, 5.431.223 euro. Het budget werd nauwgezet bewaakt door een onafhankelijke controlecommissie, en als volgt besteed: 34% voor begeleiding, omkadering en organisatie, 28% voor onkosten en vergoedingen leden, 16% voor logistiek en onthaal, 9% voor communicatie, 6% voor communicatie met regering, 5% voor lotingskosten, 2% voor onkosten experten. Dat lijkt een groot bedrag maar is behoorlijk weinig gezien het belang van het mandaat van een Burgerparlement rond de ecologische noodtoestand. Ook is het relatief laag in vergelijking met bijvoorbeeld de kostprijs van de <a target="_blank" href="https://www.senate.be/event/20191213-budget/20191213-budget_nl.html">Belgische Senaat</a>, een instelling met zo goed als geen bevoegdheden meer en een jaarlijks budget van 46 miljoen euro. Of vergelijk dit met de 70 miljoen euro subsidies die alle Belgische partijen samen jaarlijks ontvangen.',
    answer: '',
